...
import { LayoutDashboard, Users, CreditCard, Shield, ClipboardList, Download, Upload, FileCheck, ClipboardCheck, LogOut, MessageSquareWarning, Star } from "lucide-react";
...
const navItems = [
  ...
  { to: "/satisfaction", icon: Star, label: "Satisfaction" },
