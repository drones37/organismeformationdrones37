...
import { ClipboardList, Upload, Download, Trash2, FileText } from "lucide-react";
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Actions correctives et axes d'amélioration</p>
        </div>
      ...
      <div className="bg-card rounded-xl border border-border p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="font-heading font-semibold text-lg">Documents du plan d'amélioration</h2>
        </div>
        <p className="text-sm text-muted-foreground mb-6">
          Déposez ici vos fiches d'actions correctives, plans d'amélioration, rapports d'audit et bilans qualité.
        </p>

        {docs.length === 0 ? (
          <div className="text-center py-12 text-muted-foreground">
            <ClipboardList className="w-10 h-10 mx-auto mb-3 opacity-30" />
            <p>Aucun document d'amélioration continue</p>
